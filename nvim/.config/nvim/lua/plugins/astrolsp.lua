...
return {
  ...
  opts = {
    ...
    handlers = {
      ...
      --   local in_project = current_dir == project_root or string.find(current_dir, project_root .. "/")
      --
      --   print("Current directory: " .. current_dir)
      --   print("Project root: " .. project_root)
      --   print("Is in project: " .. tostring(in_project))
      --
      --   if in_project then
      --     opts.cmd = { "nc", "localhost", "9000" }
      --     print "Setting pyright cmd to: nc localhost 9000"
      --   else
      --     print "Using default pyright cmd"
      --   end
